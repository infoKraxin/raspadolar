...
export default function ProfilePage() {
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://raspadinha-api.onrender.com/v1/api/users/withdraw",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            pix_type: pixTypeMap[
              withdrawData.keyType as keyof typeof pixTypeMap
            ],
  ...
  const fetchFinancialHistory = async () => {
    ...
    try {
      const response = await fetch(
        "https://raspadinha-api.onrender.com/v1/api/users/financial-history",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const fetchGameHistory = async () => {
    ...
    try {
      const response = await fetch(
        "https://raspadinha-api.onrender.com/v1/api/users/game-history?limit=10",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const fetchAffiliatesData = async () => {
    ...
    try {
      const response = await fetch(
        "https://raspadinha-api.onrender.com/v1/api/affiliates/my-data",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  useEffect(() => {
    ...
    const fetchProfileData = async () => {
      try {
        const response = await fetch(
          "https://raspadinha-api.onrender.com/v1/api/users/profile",
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
          ...
          <div className="lg:col-span-1">
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
              <div className="flex items-center gap-4 mb-8 pb-6 border-b border-neutral-700">
                <div
                  className={`w-16 h-16 ${getAppGradient()} rounded-full flex items-center justify-center overflow-hidden`}
                >
                  <Image
                ...
                <div>
                  <h3 className="text-white font-semibold text-lg">
                    {isLoading
                      ? "Carregando..."
                      : getFirstName(profileData?.full_name || user?.full_name || "")}
                  </h3>
                  <p className="text-neutral-400 text-sm">
                    {isLoading
                      ? "Carregando..."
                      : profileData?.email || user?.email || "email@exemplo.com"}
                  </p>
                </div>
              </div>
              <div className="mb-8 p-4 bg-gradient-to-r from-neutral-500/10 to-neutral-600/10 rounded-lg border border-neutral-500/20">
                <p className={`${getAppColorText()} text-sm font-medium mb-1`}>
                  Seu saldo
                </p>
                          ...
                          <Input
                            ...
                            value={
                              profileData?.inviteCode?.code
                                ? `https://raspadolar.vercel.app/?ref=${profileData.inviteCode.code}`
                                : ""
                            }
                            readOnly
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent className="bg-neutral-700 border-neutral-600">
                          <SelectItem
                            value="cpf"
                            className="text-white hover:bg-neutral-600 focus:bg-neutral-600"
                          >
                            CPF
                          </SelectItem>
                          <SelectItem
                  ...
                  <div className="mt-8 pt-6 border-t border-neutral-700">
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Button
                        ...
                        className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-2 px-6 rounded-lg transition-all duration-300 shadow-lg"
                        type="button"
                      >
              ...
              {activeSection === "financial" && (
                <div>
                  ...
                  {isLoadingHistory ? (
                    ...
                    (financialHistory.deposits.length === 0 &&
                      financialHistory.withdraws.length === 0) ? (
                    <div className="text-center py-12">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="p-4 bg-gradient-to-r from-green-500/10 to-green-600/10 rounded-lg border border-green-500/20">
                          ...
                          <p className="text-white text-xl font-bold">
                            R${" "}
                            {parseFloat(
                              financialHistory.summary.total_deposits
                            ).toFixed(2)}
                          </p>
                        </div>
                        <div className="p-4 bg-gradient-to-r from-red-500/10 to-red-600/10 rounded-lg border border-red-500/20">
                          ...
                          <p className="text-white text-xl font-bold">
                            R${" "}
                            {parseFloat(
                              financialHistory.summary.total_withdraws
                            ).toFixed(2)}
                          </p>
                        </div>
                        <div className="p-4 bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 rounded-lg border border-yellow-500/20">
                          ...
                          <p className="text-white text-xl font-bold">
                            R${" "}
                            {parseFloat(
                              financialHistory.summary.pending_withdraws
                            ).toFixed(2)}
                          </p>
                        </div>
                      </div>
                      {financialHistory.deposits &&
                        financialHistory.deposits.length > 0 && (
                          <div>
                            ...
                            <div className="space-y-3">
                              {financialHistory.deposits.map((deposit: any) => (
                                <div
                                  key={deposit.id}
                                  className="p-4 bg-neutral-700/50 rounded-lg border border-neutral-600"
                                >
                                      ...
                                      <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                          <p className="text-white font-medium">
                                            {deposit.symbol}{" "}
                                            {parseFloat(deposit.amount).toFixed(
                                              2
                                            )}
                                          </p>
                                          <p className="text-neutral-400 text-sm">
                      ...
                      {financialHistory.withdraws &&
                        financialHistory.withdraws.length > 0 && (
                          <div>
                            ...
                            <div className="space-y-3">
                              {financialHistory.withdraws.map(
                                (withdraw: any) => (
                                  <div
                                    key={withdraw.id}
                                    className="p-4 bg-neutral-700/50 rounded-lg border border-neutral-600"
                ...
                <div>
                  ...
                  {isLoadingGameHistory ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-neutral-500 text-sm">
                        Seu histórico de jogos aparecerá aqui.
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        {gameHistory.map((game: any) => (
                          <div
                            key={game.id}
                            className="bg-neutral-700/50 rounded-lg p-4 border border-neutral-600"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  <h4 className="text-white font-medium">
                                    {game.scratch_card_name}
                                  </h4>
                                  <span
                                    className={`text-sm font-medium ${getGameStatusColor(
                                      game.is_winner,
                                      game.status
                                    )}`}
                                  >
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                  <div>
                                    ...
                                    <p className="text-white font-medium">
                                      R${" "}
                                      {parseFloat(game.price_paid).toFixed(2)}
                                    </p>
                                  </div>
                                  <div>
                                    ...
                                    <p
                                      className={`font-medium ${
                                        parseFloat(game.amount_won) > 0
                                          ? "text-green-400"
                                          : "text-neutral-400"
                                      }`}
                                    >
                                      R${" "}
                                      {parseFloat(game.amount_won).toFixed(2)}
                                    </p>
                                  </div>
                                  <div>
              ...
              {activeSection === "affiliates" && (
                <div>
                  ...
                  {isLoadingAffiliates ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 p-6 rounded-lg border border-yellow-400/20">
                          ...
                          <p className="text-2xl font-bold text-yellow-400">
                            {affiliatesData.stats.total_invites}
                          </p>
                        </div>
                        <div className="bg-gradient-to-br from-green-500/20 to-green-600/20 p-6 rounded-lg border border-green-400/20">
                          ...
                          <p className="text-2xl font-bold text-green-400">
                            R${" "}
                            {parseFloat(
                              affiliatesData.stats.total_commission
                            ).toFixed(2)}
                          </p>
                        </div>
                        <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 p-6 rounded-lg border border-blue-400/20">
                          ...
                          <p className="text-2xl font-bold text-blue-400">
                            {affiliatesData.stats.commission_rate}%
                          </p>
                        </div>
                      </div>
                      <div>
                        ...
                        {affiliatesData.invitedUsers.length === 0 ? (
                          ...
                          <div className="space-y-3">
                            {affiliatesData.invitedUsers.map(
                              (invUser: any, idx: number) => (
                                <div
                                  key={idx}
                                  className="p-4 bg-neutral-700/50 rounded-lg border border-neutral-600"
                                >
                    ...
                    <div className="text-center py-12">
                      <p className="text-neutral-400 text-lg mb-2">
                        Não foi possível carregar os dados de afiliado.
                      </p>
