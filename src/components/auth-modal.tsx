...
    phone: '', // Não é enviado ao backend com esta lógica
    cpf: '' // Não é enviado ao backend com esta lógica
  });
...
                  {/* Phone Field (mantido no front-end para validação) */}
                  <div className="relative">
...
                  {/* CPF Field (mantido no front-end para validação) */}
                  <div className="relative">
...
                  <label htmlFor="remember" className="flex items-center gap-2 text-neutral-400 cursor-pointer">
...
                    Concordo com os{' '}
                    <button type="button" className="text-white hover:text-white transition-colors cursor-pointer font-medium">
                      Termos de Uso
                    </button>
                    {' '}e{' '}
                    <button type="button" className="text-white hover:text-white transition-colors cursor-pointer font-medium">
